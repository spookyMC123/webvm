...
PANEL_NAME = os.getenv('PANEL_NAME', 'Nexo-VM-Panel')
HOSTING_NAME = os.getenv('HOSTING_NAME', 'NexoHost')
WELCOME_MESSAGE = os.getenv('WELCOME_MESSAGE', 'Welcome to NexoHost! Power Your Future!')
CURRENCY_SYMBOL = os.getenv('CURRENCY_SYMBOL', '৳')
CURRENCY_CODE = os.getenv('CURRENCY_CODE', 'BDT')

# Company Information
COMPANY_INFO = {
    'name': os.getenv('COMPANY_NAME', 'NexoHost'),
    'website': os.getenv('COMPANY_WEBSITE', 'https://www.nexohost.online'),
    'status_page': os.getenv('COMPANY_STATUS_PAGE', 'https://status.nexohost.online'),
    'discord': os.getenv('COMPANY_DISCORD', 'https://discord.gg/tsZKtJWR7n'),
    'support_email': os.getenv('COMPANY_SUPPORT_EMAIL', 'nexohostsup@gmail.com')
}

# Developer Credits
DEVELOPER_INFO = {
    'name': os.getenv('DEVELOPER_NAME', 'Joy (@! N!GHT .EXE.</>)'),
    'company': os.getenv('DEVELOPER_COMPANY', 'NexoHost'),
    'powered_by': os.getenv('POWERED_BY', 'InfinityForge')
}
...
VPS_PLANS = {
    "starter": {
        ...
        "cpu": 2,
        "disk": 50,
        "price": f"{CURRENCY_SYMBOL}49/month",
        "color": "#00ff88"
    },
    "basic": {
        "name": "Basic Plan",
        ...
        "cpu": 4,
        "disk": 100,
        "price": f"{CURRENCY_SYMBOL}99/month",
        "color": "#0099ff"
    },
    "pro": {
        "name": "Pro Plan",
        ...
        "cpu": 6,
        "disk": 200,
        "price": f"{CURRENCY_SYMBOL}199/month",
        "color": "#ffaa00"
    },
    "enterprise": {
        ...
        "cpu": 8,
        "disk": 300,
        "price": f"{CURRENCY_SYMBOL}250/month",
        "color": "#ff3300"
    },
    "ultimate": {
        "name": "Ultimate Plan",
        ...
        "cpu": 12,
        "disk": 300,
        "price": f"{CURRENCY_SYMBOL}399/month",
        "color": "#aa00aa"
    }
}
...
def load_users():
    try:
        ...
        default_users = {
            "admin": {
                "username": "admin",
                "email": os.getenv('ADMIN_EMAIL', 'admin@nexohost.online'),
...
# Context Processor - Inject company and developer info into all templates
@app.context_processor
def inject_global_context():
    """Inject company and developer information into all templates"""
    return {
...
║   Powered by: {DEVELOPER_INFO['powered_by']}                  ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝
    """)
